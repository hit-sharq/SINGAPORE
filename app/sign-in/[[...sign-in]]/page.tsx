            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  disabled={status === 'loading'}
                  className="h-12 rounded-xl border border-white/10 bg-white/[0.03] text-[#f5f1e8] text-sm font-medium hover:bg-white/[0.06] transition-all disabled:opacity-50"
                >
                  <svg className="size-5 mx-auto" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <button
                  ...
                  className="h-12 rounded-xl border border-white/10 bg-white/[0.03] text-[#f5f1e8] text-sm font-medium hover:bg-white/[0.06] transition-all disabled:opacity-50"
                >
                  <svg className="size-5 mx-auto" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
