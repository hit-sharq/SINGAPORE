...
export default function SignInPage() {
  ...
  signIn: {
    ...
    alternativeMethods: 'Or continue with',
    forgotPassword: 'Forgot password?',
    footerActionLink: 'Create account',
